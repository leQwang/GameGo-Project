...
const GenreNav: React.FC<GenreNavProps> = ({
  ...
  return (
    <div
      className={`fixed top-10 flex-col md:relative md:top-0 md:flex ${isSidenavOpen ? "left-0 top-10 w-full rounded-lg bg-[#1F140A]" : "-left-[100%]"} z-20 mt-5 transition-all duration-300 ease-in-out md:left-0`}
    >
      <div
      ...
      >
        ...
        <ul className="max-h-[calc(100vh-100px)] overflow-y-scroll md:max-h-fit md:overflow-y-hidden">
